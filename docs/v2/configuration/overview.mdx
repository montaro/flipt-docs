...
| authentication.methods.oidc.providers.[provider].discovery_url              | Override URL for the OIDC discovery document (e.g. Azure AD B2C) |           | v2.13.0 |
| authentication.methods.oidc.providers.[provider].claims_mapping             | JSON Pointer map for extracting user attributes from claims      | {}        | v2.13.0 |
